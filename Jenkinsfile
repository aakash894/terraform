pipeline {
    agent any
    //properties([parameters([choice(choices: ['us-west-2a', 'us-west-2b', 'us-west-2c', 'us-west-2d'], description: 'Select the availability zone in which you want to create your subnet', name: 'AZ1'), choice(choices: ['us-west-2a', 'us-west-2b', 'us-west-2c', 'us-west-2d'], description: 'Select the availability zone for higher availibity of your resources', name: 'AZ2'), string(defaultValue: 'ami-017fecd1353bcc96e', description: 'Input amazon image id', name: 'AMI', trim: true), string(defaultValue: 't2.medium', description: 'Input instance type', name: 'instance_type', trim: true), string(defaultValue: 'oregon', description: 'Input key pair name which you want to provide to your machine & ensure it will be pre-generated', name: 'key_name', trim: true), string(defaultValue: '3', description: 'Input node count for your database cluster', name: 'node_count', trim: true)])])
    stages {
